...
<script type="text/javascript">
	...
	function showList(areaData) {
		...
		$.each(areaData.item, function(i, data) {
			...
			let thumbnail = "<img src='resources/image/default/default_restaurant.jpg' class='thumbnail'/>";
		    if (data.firstimage)
...
<div id="all">
	...
	<div id="header">
		<img src="resources/image/default/default_restaurant2.jpg"/>
		<div class="title">음식점</div>
	</div>
	<div id="location">
		<div class="title">지역별 음식점</div>
