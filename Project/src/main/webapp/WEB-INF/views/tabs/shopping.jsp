...
<script type="text/javascript">
	...
	function showList(areaData) {
		...
		$.each(areaData.item, function(i, data) {
			...
			let thumbnail = "<img src='resources/image/default/default_shopping2.jpg' class='thumbnail'/>";
		    if (data.firstimage)
...
<div id="all">
	...
	<div id="header">
		<img src="resources/image/default/default_shopping3.jpg"/>
		<div class="title">쇼핑/시장</div>
	</div>
	<div id="location">
		<div class="title">지역별 쇼핑/시장</div>
