...
<script type="text/javascript">
	...
	function showList(areaData) {
		...
		$.each(areaData.item, function(i, data) {
			...
			let thumbnail = "<img src='resources/image/default/default_hotel.jpg' class='thumbnail'/>";
		    if (data.firstimage)
...
<div id="all">
	...
	<div id="header">
		<img src="resources/image/default/default_hotel2.jpg"/>
		<div class="title">숙박</div>
	</div>
	<div id="location">
		<div class="title">지역별 숙소</div>
